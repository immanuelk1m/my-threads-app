...
export const authConfig = {
    providers: [
        ...
        GitHub({
            clientId: process.env.AUTH_GITHUB_ID, // Use appropriate env var if testing actual login
            clientSecret: process.env.AUTH_GITHUB_SECRET, // Use appropriate env var if testing actual login
        }),
